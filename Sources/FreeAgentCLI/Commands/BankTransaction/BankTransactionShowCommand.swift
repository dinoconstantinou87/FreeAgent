...
struct BankTransactionShowCommand: ShowCommand {
    ...
    static let tables = [
        FieldTable<Components.Schemas.BankTransaction>("Explanations", items: { $0.bankTransactionExplanations }) {
            ExplanationListCommand.columns
        }
    ]

    static var sections: [FieldSection<Components.Schemas.BankTransaction>] {
