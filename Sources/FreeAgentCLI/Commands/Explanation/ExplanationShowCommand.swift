...
struct ExplanationShowCommand: ShowCommand {
    ...
    static let sections: [FieldSection<Components.Schemas.BankTransactionExplanation>] = [
    ...
    static let tables = [
        FieldTable<Components.Schemas.BankTransactionExplanation>("Attachments", columns: [
